class Codeflash < Formula
  ...
  homepage "https://github.com/ZestBox-18/CodeFlash"
  version "1.0.0"

  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/ZestBox-18/CodeFlash/releases/download/v1.0.0/codeflash-server-macos-arm64.tar.gz"
      ...
      url "https://github.com/ZestBox-18/CodeFlash/releases/download/v1.0.0/codeflash-server-macos-amd64.tar.gz"
